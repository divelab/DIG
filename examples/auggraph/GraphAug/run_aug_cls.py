...
parser.add_argument('--aug_model_path', type=str,
                    default='./dig/auggraph/method/GraphAug/results/generator_results/{}/max_augs_{}/{}.pt'.format(dataset_name.value, conf[GENERATOR_PARAMS][MAX_NUM_AUG], str(generator_checkpoint).zfill(4)),
                    help='The directory where generator states are stored after each epoch.')
parser.add_argument('--aug_cls_results_path', type=str,
                    default='./dig/auggraph/method/GraphAug/results/aug_cls_results/{}'.format(conf[MODEL_NAME].value),
