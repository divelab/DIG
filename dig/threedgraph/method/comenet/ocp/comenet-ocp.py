...
class SimpleInteractionBlock(torch.nn.Module):
    def __init__(
        ...
        if use_angle_feature:
            ...
            self.lin_feature1 = TwoLayerLinear(num_radial, hidden_channels, hidden_channels, hetero=hetero)
            self.lin_feature2 = TwoLayerLinear(num_radial, hidden_channels, hidden_channels, hetero=hetero)
...
class ComENet(nn.Module):
    def __init__(
        ...
        self.use_angle_feature = use_angle_feature
        ...
        self.interaction_blocks = torch.nn.ModuleList(
            [
                SimpleInteractionBlock(
                    ...
                    act,
                    hetero=hetero,
                    use_angle_feature=use_angle_feature
                )
