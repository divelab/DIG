...
class SimpleInteractionBlock(torch.nn.Module):
    def __init__(
        ...
        if use_angle_feature:
            ...
            self.lin_feature1 = TwoLayerLinear(num_radial, hidden_channels, hidden_channels)
            self.lin_feature2 = TwoLayerLinear(num_radial, hidden_channels, hidden_channels)
