...
print(args)
model = dimenetpp(args.cutoff, args.num_layer, args.hidden_channels, args.num_task, args.int_emb_size, args.basis_emb_size, args.out_emb_size, args.num_spherical, args.num_radial, output_init=args.output_init)
