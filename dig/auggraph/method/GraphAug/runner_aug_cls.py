...
class RunnerAugCls(object):
    r"""
    Runs a graph classification model using the augmented data generated by
    the already trained generator. Check
    ...
    def train_test(self, out_root_path, log_file = 'record.txt'):
        r"""
        This method is used to run the training epochs for the classification
        model on the augmented graph dataset and then validate the epoch
        parameters.
