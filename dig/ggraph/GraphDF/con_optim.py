...
class ConOptim(object):
    ...
    def constrained_optimize_one_mol_rl(self, adj, x, org_smile, mol_size, bfs_perm_origin, max_size_rl=38, temperature=[0.3,0.3]):
        """
    ...
    def constrained_optimize(self, num_max_node=38, temperature=[0.3,0.3], save_mol=True):
